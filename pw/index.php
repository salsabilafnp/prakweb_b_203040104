...
<body class="bg-1">
  ...
  <section id="data" class="container text-center my-3">
    ...
    <div class="row mt-3 justify-content-evenly">
      <h1 class="mb-4">Pesona's Product</h1>
      <?php foreach ($books as $book) : ?>
        <div class="card me-2 mb-3 col-sm-5 col-md-5">
          <div class="row">
            <div class="col-md-4 m-2">
              <img src="../img/<?= $book["gambar"]; ?>" class="img-fluid rounded" width="125px">
            </div>
            <div class="col-md-7">
              <div class="card-body">
  ...
  <!-- Footer -->
  <footer>
    <p class="text-center my-0 py-2 bg-main text-sec font-poppins">&copy; 2022 Salsabila FNP - 203040104</p>
  </footer>
