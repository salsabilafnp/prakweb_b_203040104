    ...
    <div class="container text-center">
      <div class="row mb-2 justify-content-around">
        <div class="col-md-3 pb-3">
          <img class="img-thumbnail" src="../../img/<?= $books["gambar"]; ?>">
        </div>
        <div class="col-md-5 align-self-center">
          <div class="card">
            <div class="card-body">
              <h1 class="display-6 card-title text-uppercase fw-bold"><?= $books["judul_buku"]; ?></h1>
              <p class="fst-italic fw-bold"><?= $books["pengarang"]; ?></p>
              <p class="fst-italic"><?= $books["genre"]; ?></p>
      ...
      <a class="btn btn-outline-secondary my-3" href="../index.php">Back to The List</a>
    </div>
  </section>
